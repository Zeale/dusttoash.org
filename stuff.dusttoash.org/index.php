<?php t("Stuff", array("<link rel=\"stylesheet\" type=\"text/css\" href=\"/index.css\">"));?>
		<section id="Introduction">
			...
			<div><i>A collection of general purpose, elegantly crafted, free tools for day-to-day work.</i></div>
			<div id="DownloadButton">
				<a href="/download" class="button-element">Download</a>
			</div>
		</section>
		<section id="Features">
			<h2 id="FeatureTitle">Features</h2>
